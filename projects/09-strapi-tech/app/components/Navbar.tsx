...
export default function Navbar() {
  ...
  return (
    <Disclosure as='nav'>
      {({ open }) => (
        <>
          <header className='max-w-6xl mx-auto my-4 px-4 sm:px-6 lg:px-8'>
            <div className='flex justify-between items-center h-16'>
              <nav className='flex justify-between items-center w-full'>
                <div className='flex items-center'>
                  <Link to='/'>
                    <h1 className='text-2xl font-medium'>
                      Tech <span className='text-teal-500'>List</span>
                    </h1>
                  </Link>
                </div>
                ...
                <div className='hidden sm:ml-6 sm:flex sm:space-x-8'>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      isActive
                        ? 'border-teal-500 dark:bg-gray-900 dark:text-white h-full inline-flex items-center px-1 py-1 border-b-2 text-sm font-medium'
