      ...
      <div className='items-center spacey-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0'>
        <div className='flex flex-col items-center pt-8'>
          ...
          <p className='text-gray-500 dark:text-gray-400 text-center'>
            Hey my name is Cesar and I am a Full Stack Developer
          </p>

          <div className='flex space-x-5 pt-6'>
            <a href='https://github.com/chicho69-cesar' target='_blank'>
              <svg
            ...
            <a
              href='https://www.linkedin.com/in/cesarvillalobosolmos/'
              target='_blank'
            >
              <svg
                viewBox='0 0 1024 1024'
            ...
            <a href='mailto:cesar@google.com' target='_blank'>
              <svg
                viewBox='0 0 1024 1024'
                fill='currentColor'
                className='w-8 h-8 text-teal-500 hover:text-teal-600'
            ...
            <a href='https://twitter.com/chicho69-cesar' target='_blank'>
              <svg
                viewBox='0 0 1024 1024'
                fill='currentColor'
                className='w-8 h-8 text-teal-500 hover:text-teal-600'
        ...
        <div className='prose max-w-none prose-lg pt-8 pb-8 dark:prose-invert xl:col-span-2'>
          <p>
            Hey everyone my name is Cesar, I am 22 years old and i am a Full Stack
            developer based in Ags/México
          </p>
          ...
          <p>
            Building applications with React and Remix.run or Next.js and sharing them on
