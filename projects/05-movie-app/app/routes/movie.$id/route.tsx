...
export const loader: LoaderFunction = async ({ params }) => {
  const url = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?language=en-US`, {
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxZjcxYzhlZTc2MTQ5YzMyYTY0ZjdmMWY5NzI4YTQ1NiIsInN1YiI6IjYyOGY3MTk2N2Q1ZGI1MTBhNTFhYWRiMiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.B_vDUKStREHoxsHJiUGMkTWCENZwPcxPo4HXm2m3lIY',
    },
  })
